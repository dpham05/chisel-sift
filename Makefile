...
gaussian: source/*.scala
	$(SBT) "run Gaussian_160_120_5 --genHarness --compile --test --backend c --targetDir emulator --vcd --debug $(CHISEL_FLAGS)" | tee emulator/gaussian_160_120_5
